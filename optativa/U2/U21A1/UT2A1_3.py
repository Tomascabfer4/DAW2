...
while True:
    puntuacionUsuario = float(input("Por favor, indique su puntuacion: "))
    if (puntuacionUsuario == 0.0):
        print ("Tu puntuación es inaceptable")
        break
    elif (puntuacionUsuario == 0.4):
        print("Tu puntuacion es aceptable")
        break
    elif( puntuacionUsuario >= 0.6):
        print("Tu puntuacion es meritoria")
        break
    else:
        print("No has introducido una puntuacion valida")
